...
function obtenerMayor(x, y) {  // "x" e "y" son números enteros (int).
...
function colors(color) {if (color==="blue") {return "This is blue";} else if (color==="red") {return "This is red";} else if (color==="green") {return "This is green";} else if (color==="orange") {return "This is orange";} else {return "Color not found";}
...
function tablaDelSeis(){
 ...
 let arrayTabla6 = []
 for (var i=0; i<11; i++) {arrayTabla6.push (6*i)} return arrayTabla6
}
...
if (numero>99 && numero<=999) {return true;} else {return false;}}
